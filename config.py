...
sim_runs = 500 #number of times simulator should loop overall

days = 30 # number of days of schedule to create
slots_per_day = 10 # number of appointment slots each day should have
duration = 30 #duration of appointments
total_entries = slots_per_day * days
density = 10 # density of initially created schedule as percent
